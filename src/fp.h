...
enum {
    FPM_GETPARAM_STATUS_REG,
    FPM_GETPARAM_SYSTEM_ID,
    FPM_GETPARAM_CAPACITY,
    FPM_GETPARAM_SECURITY_LEVEL,
    FPM_GETPARAM_DEVICE_ADDR,
    FPM_GETPARAM_PACKET_LEN,
    FPM_GETPARAM_BAUD_RATE
};
...
#define FPM_DEFAULT_TIMEOUT         200
...
class FPM {
    public:
        ...
        int16_t readParams(FPM_System_Params * params);
    ...
    private: 
        ...
        int16_t getReply(uint8_t * pktid);
